...
const Modal = (props: { btn: React.ReactNode, text: string }) => {
    ...
    return (
        <div className="fixed top-0 left-0 w-full h-full flex justify-center items-center z-[10001]">
            <div className="w-[335px] pb-[20px] bg-neutral-50 rounded-xl inline-flex flex-col justify-start items-center gap-[16px]">
                <div className="self-stretch p-[12px] inline-flex justify-end items-center gap-100px">
                    <CloseIcon className="w-6 h-6 relative" alt="close" width={20} height={20} />
                </div>
